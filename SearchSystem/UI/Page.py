...
class Page_1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_bitmap1 = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./SearchSystem/paddle_signal.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2.Add( self.m_bitmap1, 0, wx.ALL, 10 )

		bSizer3 = wx.BoxSizer( wx.HORIZONTAL )

		self.List_Keywords = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 100,400 ), wx.LC_REPORT )
		bSizer3.Add( self.List_Keywords, 0, wx.ALL, 15 )


		self.List_Description = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 600,400 ), wx.LC_REPORT )
...
#################这里有三张模型的图片哟！################
		self.Modle_A_Picture = wx.StaticBitmap(self, wx.ID_ANY,wx.Bitmap(u"./SearchSystem/paddle_signal.png",wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, 0)
		gSizer11.Add(self.Modle_A_Picture, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)
		self.Modle_B_Picture = wx.StaticBitmap(self, wx.ID_ANY,wx.Bitmap(u"./SearchSystem/paddle_signal.png",wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, 0)
		gSizer11.Add(self.Modle_B_Picture, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)
		self.Modle_C_Picture = wx.StaticBitmap(self, wx.ID_ANY,wx.Bitmap(u"./SearchSystem/paddle_signal.png",wx.BITMAP_TYPE_ANY), wx.DefaultPosition, wx.DefaultSize, 0)
